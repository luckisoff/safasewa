...
class cleanto_booking{
	...
	*/
	public function add_booking(){
		$query="insert into `".$this->table_name."` (`id`,`order_id`,`client_id`,`order_date`,`booking_date_time`,
		`service_id`,`method_id`,`method_unit_id`,
		`method_unit_qty`,`method_unit_qty_rate`,
		`booking_status`,`reject_reason`,`reminder_status`,
		`lastmodify`,`read_status`,`staff_ids`,`gc_event_id`,`gc_staff_event_id`,`lat`,`lng`) 
		values(NULL,'".$this->order_id."','".$this->client_id."',
		'".$this->order_date."','".$this->booking_date_time."','".$this->service_id."',
	...
	*/
	...
	public function getallbookings($start_date = "",$end_date = ""){
		...
		$query = "SELECT `p`.`order_id`, `b`.`booking_status`, `b`.`client_id`, `b`.`booking_date_time`, `s`.`color`, `s`.`title`, `p`.`net_amount` FROM `ct_bookings` as `b`,`ct_services` as `s`,`ct_payments` as `p`
		WHERE
	...
	*/
	...
	public function get_all_bookings(){
		$query = "select `order_id`, `client_id`, `service_id`, `booking_status`, `order_date`, `booking_date_time` from `ct_bookings` GROUP BY `order_id`, `client_id`, `service_id`, `booking_status`, `order_date`, `booking_date_time` ORDER BY `order_id` ";
		$result=mysqli_query($this->conn,$query);
		return $result;
	}
