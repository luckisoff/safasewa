...
class cleanto_users{
	...
	public function add_user(){
		...
		$query="insert into `".$this->table_name."` (`id`,
		            `user_email`,`user_pwd`,`first_name`,`last_name`,`phone`,`zip`,`address`,
		            `city`,`state`,`notes`,`vc_status`,`p_status`,
		            `contact_status`,`status`,`usertype`,`cus_dt`,`stripe_id`,`social_id`,`social_type`) 
		            values(NULL,'".$this->user_email."','".$this->user_pwd."','".$this->first_name."',
		            '".$this->last_name."','".$this->phone."','".$this->zip."','".$this->address."','".$this->city."','".$this->state."','".$this->notes."',
		            '".$this->vc_status."','".$this->p_status."','".$this->contact_status."','".$this->status."','".$this->usertype."','".$dftdt."','".$this->stripe_id."',
		            '".$this->social_id."',
		            '".$this->social_type."')";
...
// 	social login
	...
	public function check_social_login_process(){
		$query="SELECT * FROM `".$this->table_name."` WHERE `social_id`='".$this->social_id."' and `social_type`='".$this->social_type."' AND `status`='E'";
		$result=mysqli_query($this->conn,$query);
...
// 	social login
  ...
  public function get_addon_name($order_id){
    ...
    $query = "select `ct_bookings`.`order_id`,`ct_order_client_info`.* from `ct_bookings`,`ct_order_client_info` where `ct_bookings`.`client_id` = 0 and `ct_bookings`.`order_id` =`ct_order_client_info`.`order_id` GROUP BY `ct_bookings`.`order_id`, `ct_order_client_info`.`id`, `ct_order_client_info`.`order_id`, `ct_order_client_info`.`client_name`, `ct_order_client_info`.`client_email`, `ct_order_client_info`.`client_phone`, `ct_order_client_info`.`client_personal_info`  ORDER by `ct_bookings`.`order_id`";
		$result=mysqli_query($this->conn,$query);
		return $result;
  }
