			...
			<div class="ct-legends-inner">
				<ul class="list-inline nm">
					...
					if($gc_hook->gc_purchase_status() == 'exist'){
						?><li><i class="fa fa-google txt-primary"></i>Google Event</li><?php         
					}
					?>
			...
			<div class="modal-content">
				...
				<div class="modal-body mb-20">
					<ul class="list-unstyled ct-cal-booking-details">
						...
						<li class="li_of_duration <?php   if ($setting->get_option('ct_show_time_duration') == 'N') {echo "force_hidden";} ?>">
							<label><?php  echo $label_language_values['duration'];?></label>
							<span class="duration span-scroll"></span>
						</li>
						<li><h6 class="ct-customer-details-hr"><?php  echo $label_language_values['customer'];?></h6></li>
						<li>
						...
						<li class="li_of_notes">
							...
							<span class="span-scroll">
								<a href="https://www.google.com/maps/dir/?api=1&origin=34.1030032,-118.41046840000001&destination=34.059808,-118.368152" target="_new">
									View in map
								</a>
							</span>
						</li>
