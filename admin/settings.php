							...
							<table class="form-inline ct-common-table">
								<tbody>
									<tr>
										...
										?>
										<td class="plans_on_stripe_labels" style="display: <?php     echo $plans_on_stripe_d; ?>;"><label><?php echo $label_language_values['plans_on_stripe'];?></label></td>
										<td class="plans_on_stripe_div" style="display: <?php     echo $plans_on_stripe_d; ?>;">
											<div class="form-group">
												<label class="ctoggle-postal-code"  for="show_company_logo_header">
