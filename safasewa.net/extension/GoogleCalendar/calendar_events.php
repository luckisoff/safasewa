...
function get_providerevents($calendarId,$provider_access_token,$sdate,$edate,$GcclientID,$GcclientSecret,$GcEDvalue,$ct_gc_admin_url){
...
if($GcEDvalue == 'Y' && $provider_gc_data != ''){
	...
	$provider_events  =	get_providerevents($provider_gc_id,$provider_gc_data,$sdate,$edate,$GcclientID,$GcclientSecret,$GcEDvalue,$ct_gc_admin_url);
